...
- Follow `dev/README.md` for starting, updating, resuming, and archiving substantial work.
- Before ending a substantial session, record verification performed and leave a concrete quick-resume step in `context.md`.
